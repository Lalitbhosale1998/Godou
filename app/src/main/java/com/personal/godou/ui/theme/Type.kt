...
val KaiseiDecolFontFamily = FontFamily(Font(resId = R.font.kaisei_decol_regular, weight = FontWeight.Normal))
val KaiseiOptiFontFamily = FontFamily(Font(resId = R.font.kaisei_opti_regular, weight = FontWeight.Normal))
...
val MPlus1FontFamily = FontFamily(Font(resId = R.font.mplus1_variable, weight = FontWeight.Normal))
val NotoSansJPFontFamily = FontFamily(Font(resId = R.font.notosansjp_variable, weight = FontWeight.Normal))
...
val ReggaeOneFontFamily = FontFamily(Font(resId = R.font.reggae_one_regular, weight = FontWeight.Normal))
val RocknRollOneFontFamily = FontFamily(Font(resId = R.font.rocknroll_one_regular, weight = FontWeight.Normal))
val WDXLLubrifontJPNFontFamily = FontFamily(Font(resId = R.font.wdxl_lubrifont_jpn_regular, weight = FontWeight.Normal))
val YujiMaiFontFamily = FontFamily(Font(resId = R.font.yuji_mai_regular, weight = FontWeight.Normal))
val YuseiMagicFontFamily = FontFamily(Font(resId = R.font.yusei_magic_regular, weight = FontWeight.Normal))
